...
class Config(object):
	...
	API_ID = int(os.environ.get("API_ID", 18350255))
	...
	OWNER_ID = int(os.environ.get("OWNER_ID", 1774322076)
	CAPTION = "By @cute_girl_rani"
...
__Note: I can only process one video at a time. As my server is Heroku, my health is not good. If you have any issues with Adding Watermark to a Video, then please Report at [Support Group](https://t.me/movie4ubotschannel).__

Desgined by @doreamonfans1
"""
	PROGRESS = """
Percentage : {0}%
Done ✅: {1}
